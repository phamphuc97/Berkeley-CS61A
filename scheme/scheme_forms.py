...
def do_define_form(expressions, env):
    ...
    if scheme_symbolp(signature):
        ...
        formals = Pair(signature.rest, expressions.rest)
        env.define(name, do_lambda_form(formals, env))
        return name
        # END PROBLEM 10
    else:
...
def do_and_form(expressions, env):
    ...
    if expressions is nil:
        ...
        return False
    elif is_scheme_true(scheme_eval(expressions.first, env)) and expressions.rest is nil:
